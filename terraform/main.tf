...
locals {
  service_name   = "go-api"
  service-account  = "serviceAccount:${google_service_account.service-account-api.email}"
...
resource "google_service_account" "service-account-api" {
...
resource "google_service_account_key" "sa_key" {
  service_account_id = google_service_account.service-account-api.name
...
resource "google_project_iam_binding" "service_permissions" {
  ...
  depends_on = [google_service_account.service-account-api]
}
...
resource "google_cloud_run_service" "service" {
  ...
  template {
    spec {
      service_account_name = google_service_account.service-account-api.email
